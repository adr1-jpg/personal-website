...
const Home: React.FC = () => {
  ...
  const TypingEffect = ({ text }: { text: string }) => {
    ...
    return (
      <div
        ref={typeRef}
        className="font-lora text-blue relative greeting"
      ...
      <div className="flex bp intro">
        <div className="h-auto">
          <div className="">
            ...
            <p className="font-lora text-blue relative greeting">
              Hi, I'm Adri!
            </p>
          </div>
          <p className="text-left leading-loose desc font-openSans">
            I love tackling real-world problems that make a difference in
            people's lives.
            <br />
            Design Engineer @{" "}
            <a
      ...
      <div className="bp">
        ...
        <div className="work-container">
              ...
              <div className="one-card-body">
                <div className="card flex flex-row ">
                  <div className="content-center">
                    <img
                      src={azureTheme}
                      className="one-card-logo h-auto"
                      loading="lazy"
                    />
                  </div>
                </div>
                ...
                <div className="max-1236:mt-2 content-center">
                  <h1 className="font-lora card-title">
                    Azure Theme for Fluent UI
                  </h1>
                  <p className="font-openSans card-text">
                    A custom theme package for Fluent UI, aligning components
                    with Azure Portal's brand colors and design language.
                  </p>
                </div>
              </div>
            </Link>
          ...
          <div className="two-card-container bp">
            <Link
              to="/campus"
              className="two-card transition-transform 
                        duration-200 hover:-translate-y-2 hover:cursor-pointer"
            >
              <div className="">
                <div className="flex flex-col">
                  <div className="content-center">
                    <p className=" text-[26px] max-1236:text-[30px] font-medium font-poppins leading-tight text-campus card-brand">
                      Columbia Virtual Campus
                    </p>
                  </div>
                  <p
                    className="font-lora text-[20px] 
                                        font-medium mt-2 leading-tight card-title-two"
                  >
