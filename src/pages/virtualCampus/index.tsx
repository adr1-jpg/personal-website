...
const VirtualCampus: React.FC = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    return (
        <div id='campus' className="flex flex-col min-h-screen bg-background">
            <Header />
            <div className="">
                 <h1 className="font-openSans text-4xl mx-48 mt-10">Columbia Virtual Campus</h1>
            </div>
