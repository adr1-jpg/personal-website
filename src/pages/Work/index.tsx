      ...
      >
        <div className="max-w-[1024px] hero-body">
          <div className="w-full max-w-md max-1236:max-w-sm max-640:w-[250px] h-auto">
            <img loading="lazy" src={azureTheme} alt="Azure Theme" />
          </div>
      ...
      <div className="study-container bp">
        ...
        <div className="">
          ...
          <p className="font-openSans design-desc">
            ...
            , the latest version of their design system. I developed a custom
            theme for the Azure portal, applying Azure's brand colors to Fluent
            components. This ensured a cohesive and consistent styling,
            typography, and color scheme, aligning with Azure's design language
            and delivering a unified experience for millions of global users.
          </p>
          <div className="flex gap-3 mt-2">
            <a
              href="https://www.npmjs.com/package/@fluentui/azure-themes?activeTab=readme"
              target="_blank"
              rel="noreferrer"
            >
              <img src={npm} className="icon" alt="NPM" />
            </a>
            <a
        ...
        <div className="">
          ...
          <p className="text-[18px] leading-normal font-openSans">
            <ul className="list pl-5 design-desc">
              ...
              <li className="font-openSans">
                Easy implementation: Simply import the desired theme and wrap
                your components with
                <a
                  href="https://fluent2.microsoft.design/components/web/react/fluentprovider/usage"
                  target="_blank"
                  rel="noreferrer"
                  className="text-light-blue hover:cursor-pointer font-semibold"
                >
                  {" "}
                  FluentProvider
                </a>
          ...
          <h1 className="text-[18px] font-openSans design-desc mt-4">
            This button demonstrates the Azure Theme styling applied to a Fluent
            button. On click, it navigates to a Storybook containing a showcase
            of all Fluent components styled with the Azure Theme.{" "}
          </h1>
          <div className="demo">
            <a
              href="https://microsoft.github.io/fluentui-contrib/azure-theme/?path=/docs/packages-azure-theme--docs"
              target="_blank"
              rel="noreferrer"
            >
